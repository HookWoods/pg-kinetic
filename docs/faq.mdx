    ...
    {JSON.stringify({
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'pg-kinetic can be installed from ghcr.io/hookwoods/pg-kinetic:latest or from the Helm repository at https://helm.pgkinetic.dev. Local Docker Compose remains available for development smoke tests.',
          },
        },
        {
          '@type': 'Question',
...
The local Docker Compose and local chart paths remain useful for development and template changes. See [Installation](./installation.md) and [Quickstart](./quickstart.md).
