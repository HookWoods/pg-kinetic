...
impl PolicyRuleAction {
    ...
    #[must_use]
    pub const fn effect(&self) -> crate::traffic::policy::PolicyEffect {
        match self {
            Self::Allow { .. } => crate::traffic::policy::PolicyEffect::NoChange,
            Self::Deny { .. } => crate::traffic::policy::PolicyEffect::Deny,
            Self::RequirePrimary { .. } => crate::traffic::policy::PolicyEffect::RequirePrimary,
            Self::RequireReplica { .. } => crate::traffic::policy::PolicyEffect::RequireReplica,
            Self::RouteOverride { .. } => crate::traffic::policy::PolicyEffect::RouteOverride,
            Self::ShardOverride { .. } => crate::traffic::policy::PolicyEffect::ShardOverride,
        }
    }
