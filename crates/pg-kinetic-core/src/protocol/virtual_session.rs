...
use crate::{
    ...
    protocol::sql::{SetScope, SqlCommand},
    protocol::sql_classify::{classify_sql, for_each_top_level_statement},
...
impl VirtualSession {
    ...
    pub fn apply_transaction_sql_with_routing(
        ...
        for_each_top_level_statement(sql, |statement| {
            let command = crate::protocol::sql::classify(statement);
            ...
            self.apply_transaction_command(
                ...
                track_routing_state
                    && matches!(
                        classify_sql(statement),
                        crate::traffic::routing::QueryClass::Write
                    ),
            );
        });
