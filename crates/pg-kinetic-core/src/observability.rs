...
impl MetricName {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PressureCpu => "pg_kinetic_pressure_cpu",
            Self::PressureMem => "pg_kinetic_pressure_mem",
...
static METRIC_CATALOG: &[MetricDescriptor] = &[
    ...
    MetricDescriptor::new(
        ...
        MetricKind::Gauge,
        "1",
        "Current protocol buffer copy total by fixed feature path.",
        FEATURE_LABELS,
    ...
    MetricDescriptor::new(
        ...
        MetricKind::Gauge,
        "1",
        "Current prepared statement cache hit total.",
        NO_LABELS,
        "Single gauge without labels.",
    ),
    MetricDescriptor::new(
        ...
        MetricKind::Gauge,
        "1",
        "Current prepared statement cache miss total.",
        NO_LABELS,
        "Single gauge without labels.",
    ),
    MetricDescriptor::new(
        ...
        MetricKind::Gauge,
        "1",
        "Current observability hot-path allocation total by fixed feature path.",
        FEATURE_LABELS,
        "Feature values are fixed implementation paths, never request content.",
    ),
    MetricDescriptor::new(
