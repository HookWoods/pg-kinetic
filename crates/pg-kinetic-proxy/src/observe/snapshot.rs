...
use pg_kinetic_core::{
    cluster::ha::{HealthProbeOutcome, ReplicaLagState, RoleProbeOutcome},
    ...
    lab::benchmark::{BenchmarkResult, BenchmarkScenario},
    ...
    protocol::prepare::PreparedStatementSnapshot,
    protocol::session::PinReason,
    traffic::mirror::MirrorMode,
    traffic::policy::{PolicyAuditEvent, PolicyMode},
    ...
    pub fn new(endpoint_id: u64, endpoint_addr: SocketAddr, expected_role: BackendRole) -> Self {
        Self {
            ...
            health: HealthProbeOutcome::new(
                pg_kinetic_core::cluster::ha::EndpointHealth::Unhealthy,
                false,
                0,
            ),
            role: RoleProbeOutcome::new(
                pg_kinetic_core::cluster::ha::EndpointRoleState::Unknown,
                None,
            ),
            replay_lsn: None,
...
pub struct NodeSummarySnapshot {
    ...
    pub lifecycle_state: RuntimeLifecycleState,
    pub readiness_state: ReadinessState,
    pub health: pg_kinetic_core::cluster::control::PeerHealth,
...
impl PerformanceSnapshot {
    ...
    pub fn latest_regression_for(
        &self,
        metric: pg_kinetic_core::observability::performance::PerformanceMetric,
    ...
    pub fn comparison_outcome(
        &self,
        scenario: &str,
        target: pg_kinetic_core::lab::benchmark::BenchmarkComparison,
...
pub struct SettingsSnapshot {
    ...
    pub recovery_mode: pg_kinetic_core::cluster::recovery::RecoveryMode,
...
impl Default for SettingsSnapshot {
    fn default() -> Self {
        Self {
            ...
            recovery_mode: pg_kinetic_core::cluster::recovery::RecoveryMode::Recover,
...
fn record_policy_event(inner: &mut SnapshotStoreInner, event: PolicyAuditEvent) {
    ...
    if matches!(
        event.kind,
        pg_kinetic_core::traffic::policy::PolicyAuditKind::Decision
    ) {
